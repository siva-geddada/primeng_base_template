            ...
            <p-dataview
                ...
                <ng-template #header>
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <span class="text-xl text-surface-900 dark:text-surface-0 font-semibold"
                            >Articles</span
                        >
                        <p-select
                            [(ngModel)]="sortKey"
                ...
                <ng-template #grid let-items>
                    <div class="grid grid-cols-12 gap-4 grid-nogutter">
                        <div *ngFor="let item of items" class="col-span-12 md:col-span-4">
                            <div class="p-4">
                                <div
                                    class="bg-surface-100 dark:bg-surface-700 cursor-pointer z-index rounded">
                                    <div class="relative">
                                        <img
                                            [src]="item.coverImage"
                                            class="w-full"
                                    ...
                                    <div class="p-4">
                                        <div
                                            class="text-surface-900 dark:text-surface-0 font-semibold text-xl mb-4">
                                            {{ item.title }}
                                        </div>
                                        <p
                                            class="text-surface-700 dark:text-surface-100 text-lg mt-0 mb-8">
                                            {{ item.description }}
                                        </p>
                                        <div
                                            class="flex flex-wrap gap-2 items-center justify-between">
                                            <span
                                                class="flex items-center text-surface-900 dark:text-surface-0">
            ...
            <div class="bg-surface-0 dark:bg-surface-950 px-6 py-20 md:px-12 lg:px-20">
                ...
                <div class="grid grid-cols-12 gap-4 nogutter">
                    <div class="col-span-12 lg:col-span-4 p-6">
                        ...
                        <div
                            class="text-surface-900 dark:text-surface-0 font-medium text-xl leading-normal mb-6">
                        ...
                        <div class="flex mt-6">
                            <p-avatar
                                image="/avatar/circle/avatar-f-1.png"
                                shape="circle"></p-avatar>
                            <div class="ml-2">
                                <div
                                    class="text-xs font-bold text-surface-900 dark:text-surface-0 mb-1">
                                    Anna Miles
                                </div>
                                <div
                                    class="text-xs flex items-center text-surface-700 dark:text-surface-100">
                    ...
                    <div class="col-span-12 lg:col-span-4 p-6">
                        ...
                        <div class="flex mt-6">
                            <p-avatar
                                image="/avatar/circle/avatar-f-2.png"
                                shape="circle"></p-avatar>
                            <div class="ml-2">
                                <div
                                    class="text-xs font-bold text-surface-900 dark:text-surface-0 mb-1">
                    ...
                    <div class="col-span-12 lg:col-span-4 p-6">
                        ...
                        <div class="flex mt-6">
                            <p-avatar
                                image="/avatar/circle/avatar-f-3.png"
                                shape="circle"></p-avatar>
                            <div class="ml-2">
                                <div
                                    class="text-xs font-bold text-surface-900 dark:text-surface-0 mb-1">
    ...
    totalBlogs: any[] = [
        {
            ...
            profile: '/avatar/circle/avatar-f-1.png',
            title: 'Blog',
            description:
        ...
        },
        {
            ...
            profile: '/avatar/circle/avatar-f-2.png',
            title: 'Magazine',
            description:
        ...
        },
        {
            ...
            profile: '/avatar/circle/avatar-m-1.png',
            title: 'Science',
            description:
        ...
        },
        {
            ...
            profile: '/avatar/circle/avatar-f-3.png',
            title: 'Magazine',
            description:
        ...
        {
            coverImage: '/blog/blog-6.png',
            profile: '/avatar/circle/avatar-m-3.png',
            title: 'Science',
            description:
